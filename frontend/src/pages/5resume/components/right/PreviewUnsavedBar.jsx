...
export default function PreviewUnsavedBar({
	...
	return (
		<div
			...
			title="Save these editor changes as a resume version. Your profile stays unchanged."
		>
			<FontAwesomeIcon
			...
			>
				<span className="font-semibold text-amber-900">Unsaved resume changes</span>
