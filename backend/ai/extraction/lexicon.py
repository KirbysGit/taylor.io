...
titleAnchorHints = {
    ...
    "industrial": {"electrical engineer", "automation engineer", "controls engineer", "industrial engineer", "pcb design engineer"},
    "construction": {"construction materials professional", "field technician", "construction engineer", "site inspector", "civil engineer"},
    "healthcare": {
        "medical assistant",
        "clinic coordinator",
        "patient coordinator",
...
globalStopWords = {
    ...
    "below", "higher", "position", "transcript", "transcripts",
}
...
globalWeakTokens = {
    ...
    "degree", "education", "bachelor", "student",
...
globalPhrases = [
    ...
    "etl/elt pipelines", "data ingestion", "data transformation", "data warehouses", "data lakes",
    "data quality", "data governance", "data workflows",
    ...
    "openai", "amazon bedrock", "google ces", "dialogflow", "dialog flow", "prompt engineering",
    ...
    "civil engineering structures", "design and construction", "project design documents",
    "technical submittals", "corrective action", "criteria or specifications",
    "schematic capture", "pcb layout", "pcb design tools", "circuit board design",
    "component selection", "bill of materials", "assembly drawings", "fab drawings",
    "drill drawings", "manufacturing packages", "dfm", "dft", "emc", "high speed routing",
    "controlled impedance", "high density interconnect", "thermal management",
...
globalBoostWords = {
    ...
    "kpi": 2, "kpis": 3, "dashboarding": 2, "prompt engineering": 2, "openai": 3,
...
globalPhraseCanonical = {
    ...
    "boms": "bom",
    "high-speed routing": "high speed routing",
...
domainDicts = {
    ...
    "data": {
        ...
        "phrases": [
            ...
            "data analytics platform", "data modeling", "data models", "data quality", "data ingestion",
            "data reliability", "data storage", "data performance", "structured and unstructured data", "business intelligence",
            "working prototypes", "development specifications", "data visualization",
        ],
        "boostWords": {
            "sql": 3, "kafka": 3, "databricks": 3, "nifi": 3, "druid": 2, "mongodb": 2, "opensearch": 2, "postgres": 2,
            "database": 2, "oracle": 2, "snowflake": 2, "redshift": 2, "hadoop": 2, "airflow": 2, "sql server": 2,
            "amazon web services": 2, "google cloud platform": 2,
    ...
    "industrial": {
        "aliases": {
            ...
            "pcb", "printed circuit board", "pcb design", "pcb layout", "schematic capture", "circuit board",
            "analog electronics", "digital electronics", "power systems", "component selection", "dfm", "dft",
            "emc", "hdi", "controlled impedance", "high speed routing", "altium", "kicad", "orcad",
        },
        "phrases": [
            ...
            "schematic capture", "pcb layout", "pcb design tools", "circuit board design", "component selection",
            "bill of materials", "assembly drawings", "fab drawings", "drill drawings", "manufacturing packages",
            "analog electronics", "digital electronics", "power systems", "dfm", "dft", "emc",
            "thermal management", "controlled impedance", "high speed routing", "high density interconnect",
        ],
        "boostWords": {
            ...
            "pcb": 3, "schematic": 3, "layout": 2, "circuit": 3, "electronics": 2, "altium": 3,
            "kicad": 3, "orcad": 3, "dfm": 3, "dft": 3, "emc": 3, "hdi": 2,
        },
    ...
    "construction": {
        "aliases": {
            ...
            "civil engineer", "civil engineering", "civil engineering structures", "design and construction",
            "project design documents", "submittals", "corrective action", "criteria", "specifications",
        },
        "phrases": [
        ...
        "boostWords": {
            ...
            "civil": 3, "submittals": 3, "corrective": 2, "specifications": 2, "criteria": 2,
        },
        "weakTokens": {"labor"},
    },
    "healthcare": {
